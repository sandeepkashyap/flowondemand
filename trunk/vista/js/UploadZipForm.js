...
Pictomobile.UploadZipForm = Ext.extend(Ext.form.FormPanel, {
    ...
    constructor: function(config){
        ...
        Pictomobile.UploadZipForm.superclass.constructor.call(this, config);
    },
    initComponent: function(){
        ...
        // call parent
        Pictomobile.UploadZipForm.superclass.initComponent.apply(this, arguments);
    ...
    onRender: function(){
        ...
        // call parent
        Pictomobile.UploadZipForm.superclass.onRender.apply(this, arguments);
    ...
    submit: function(){
		if (App.data.application_id > 0) {
			...
			Ext.Msg.show({
			   title:'Error',
			   msg: 'Please choose application to upload images',
			   buttons: Ext.Msg.OK,			   
...
// register xtype
Ext.reg('picUploadZipForm', Pictomobile.UploadZipForm);
