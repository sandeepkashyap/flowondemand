<?php
   ...
   * @subpackage models
   */
  class CWireframe extends CComponent {
    ...
    /**
     * List of messages that are shown bellow the title, but above content
     *
     * @var array
     */
    ...
    function addPageAction($text, $url, $subitems = null, $additional = null, $weight = 0) {
      ...
      $this->page_actions[$weight][] = array(
        ...
        'url'      => $url,
        'subitems' => $subitems,
        'id'       => HArray::array_var($additional, 'id'),
        'method'   => HArray::array_var($additional, 'method'),
        'confirm'  => HArray::array_var($additional, 'confirm')
      );
    } // addPageAction
...
//        'icon'  => get_image_url("messages/$class.gif"),
    ...
    function &instance() {
      static $instance;
      if($instance === null) {
        $instance = new CWireframe();
      } // if
      return $instance;
    } // instance
    
    public function init() {
    	return CWireframe::instance();
    } // init
    ...
    public function setDetails($title) {
    	$this->details = $title;
    }
