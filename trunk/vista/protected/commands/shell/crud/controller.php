...
class <?php echo $controllerClass; ?> extends Controller
{
	...
	public function __construct($id,$module=null) {
		...
		Yii::app()->wireframe->addBreadCrumb('<?=$controllerClass?>', $this->createUrl('<?=$controllerClass?>/admin'));
	}
	...
	public function actionShow()
	{
		...
		Yii::app()->wireframe->addPageAction(Yii::t('application', 'New') . '<?=$className?>', $this->createUrl('<?=$controllerClass?>/create'));
	...
	{
		Yii::app()->wireframe->addBreadCrumb(Yii::t('application', 'Manage'));
