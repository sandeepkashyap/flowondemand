...
<head>
	...
	var arrSettings = new Array('database', 'server', 'gui', 'auth');
	...
	<div id="gui_table">
		<table style="border: 1px solid #c8c8c8; width: 80%;" cellspacing="0" cellpadding="3">
			...
			<tr valign="top" style="<?php echo $style2 ?>">
				...
				<td><input name="IN_userdefined1_title" type="text" class="InputText" style="width: 160px;" value="<?php echo $USERDEFINED_TITLE1 ?>"></td>
				<td>user-defined1</td>
			</tr>
			<tr valign="top" style="<?php echo $style ?>">
				<td nowrap><?php echo $CONFIG_USERDETAILS_USERDEFINED ?> 2:</td>
				<td><input name="IN_userdefined2_title" type="text" class="InputText" style="width: 160px;" value="<?php echo $USERDEFINED_TITLE2 ?>"></td>
				<td>user-defined2</td>
			</tr>
		</table>
	</div>
	...
	<div id="auth_table" style="display: none;">
		<table style="border: 1px solid #c8c8c8; width: 80%;" cellspacing="0" cellpadding="3">
			...
			<tr>
				...
				<td>
					<select name="auth_method" type="text" class="InputText" style="width: 210px;">
			...
			<tr>
				...
				<td>
					<select name="default_level" type="text" class="InputText" style="width: 210px;">
